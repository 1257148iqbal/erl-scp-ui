...
import { fullMonthYear } from 'utils/dateHelper';
...
const HeaderTitle = ({ title, fromDate, toDate }) => {
  return (
    <Fragment>
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.report}>YEARLY PRODUCTION REPORT </Text>
        <Text style={styles.reportSubTitle}>{`${fullMonthYear(fromDate)} - ${fullMonthYear(toDate)}`} </Text>
      </View>
    </Fragment>
  );
};

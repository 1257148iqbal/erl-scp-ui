...
const LogSectionDetails = props => {
  ...
  useEffect(() => {
    if (itemKey) {
      http
        .get(`${SECTION.get_single}/${itemKey}`)
        .then(res => {
      ...
      <Table className={classes.table} aria-label="custom pagination table">
        <TableBody>
          <TableRow>
            ...
            <TableCell align="left">{`: ${details.sectionName} (${details.operationGroup.groupName})`}</TableCell>
          </TableRow>
...
export default LogSectionDetails;

...
const TestSampleDetails = props => {
  ...
  useEffect(() => {
    if (itemKey) {
      http
        .get(`${TEST_SAMPLE.get_single}/${itemKey}`)
        .then(res => {
      ...
      <Table className={classes.table} aria-label="custom pagination table">
        <TableBody>
          <TableRow>
            ...
            <TableCell align="left">{`: ${details.sampleName} (${details.labUnit.unitName})`}</TableCell>
          </TableRow>
          ...
          <TableRow>
            ...
            <TableCell align="left">{`: ${details.density}`}</TableCell>
          </TableRow>
...
export default TestSampleDetails;

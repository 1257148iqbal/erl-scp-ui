...
import { getFloorTime, getNewDateBefore, getTimeBefore, getTimeFromDate, serverDate, time24 } from 'utils/dateHelper';
...
const SiteReport = () => {
  ...
  const getSiteReportWithReading = labShiftId => {
    const queryParam = {
  ...
  return (
    <PageContainer heading="Site Report (Crete)">
      <FormWrapper>
        <Form>
